...
class AddInstallmentPage extends ConsumerStatefulWidget {
  ...
  const AddInstallmentPage({super.key, this.restorationId});
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value!.isEmpty) return 'Installment title is required';
    ...
    return DialogRoute<DateTime>(
      ...
      builder: (BuildContext context) {
        ...
        return DatePickerDialog(
          ...
          helpText: 'Select an installment due date',
          cancelText: 'Cancel',
          confirmText: 'Ok',
        );
      },
...
class AddInstallmentArgs {
  const AddInstallmentArgs(this.restorationId);
